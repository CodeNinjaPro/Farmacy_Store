            ...
            <div class="page-content d-flex align-items-stretch"> 
                ...
                <nav class="side-navbar">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="active"><a href="user.jsp"> <i class="fa fa-user-plus"></i>User </a></li>
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="full_name" type="text" onkeypress="validateName()"	placeholder="username" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
